const mailTemplate = ({ name, email, verifyLink }) => {
  return `
    <div style="max-width: 500px; margin: auto; padding: 20px; font-family: Arial, sans-serif; background: #fff7d6; border: 1px solid #f5e1a4; border-radius: 8px;">
      ...
      <div style="text-align: center; margin: 30px 0;">
        <a href="${verifyLink}" style="background: #ffce00; color: #000; padding: 12px 24px; text-decoration: none; font-weight: bold; border-radius: 5px; display: inline-block;">
          Verify Email
        </a>
      </div>
